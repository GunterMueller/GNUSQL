/*
 * $Id: test11.ec,v 1.2 1998/09/29 21:26:55 kimelman Exp $
 *
...
(    SELECT MIN (TABNAME), MAX (OWNER), UNTABID --MIN (TABNAME), MAX (OWNER), UNTABID
...
--    AND
      EXISTS (
        ...
        WHERE DEFINITION_SCHEMA.SYSTABLES.UNTABID - 5 <= UNTABID --OR UNTABID > 100
      )
  GROUP BY  UNTABID 
)
    ;
